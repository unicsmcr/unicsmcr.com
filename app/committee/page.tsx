import committeeData24_25 from '@data/committee2024_25.json';
...
const Committee = () => {
	return (
		<section id="committee" className="bg-black pt-40">
			<div id="2024_2025" className="max-w-screen-xl mx-auto">
				<h2 className="text-6xl text-unics-green font-bold font-sans uppercase py-5 px-20 ">Current Committee</h2>
				<ul id="committee-list" className="pt-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 pb-8">
					{committeeData24_25.map(({ name, role, social, img, email }) => (
						<li
							key={`${name}-committee`}
			...
			<div id="2023_2024" className="max-w-screen-xl mx-auto">
				<h2 className="text-6xl text-unics-green font-bold font-sans uppercase py-5 px-20 ">2023-2024 Committee</h2>
				<ul id="committee-list" className="pt-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 pb-8">
